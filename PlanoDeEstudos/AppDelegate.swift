...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        let confirmaAction = UNNotificationAction(identifier: "Confirm", title: "Já estudei 😂", options: [.foreground])
        let cancelAction = UNNotificationAction(identifier: "Cancel", title: "Cancelar", options: [.destructive])
        let category = UNNotificationCategory(identifier: "Lembrete", actions: [confirmaAction, cancelAction], intentIdentifiers: [], options: [.customDismissAction])
